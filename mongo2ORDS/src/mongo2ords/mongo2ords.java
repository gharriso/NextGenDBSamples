...
public class mongo2ords {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		if (args.length != 8) {
			System.out.println("Args: MongoHost MongoDB MongoCollection orahost "
					+ "orauser orapass oraservice oracollection");
			System.exit(0);
		}
		String mongo = args[0];
		...
		try {
			...
			for (Document mongoDoc : mongoCollection.find()) {
				System.out.println(count++ +":"+mongoDoc.toJson());
				count++; 
